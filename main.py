...
image_path = "0000000006_image.png"

depth_path = "0000000006.png"
#Load image, convert to numpy array and divide by 256

image = np.asarray(Image.open(image_path)) /255
depth = np.asarray(Image.open(depth_path)) /255

print(image.shape)
print(depth.shape)

dense_depth = fill_depth_colorization(image, depth)
print( dense_depth.max())
low = dense_depth < 10

dense_depth[low] = 0

print(dense_depth.shape)
plt.figure(figsize=(10, 10))
plt.imshow(dense_depth )
plt.title("Ground Truth", fontsize=22)
plt.imsave("beth.png" , dense_depth , cmap = "")
plt.figure(figsize=(10, 10))
plt.imshow(image)
